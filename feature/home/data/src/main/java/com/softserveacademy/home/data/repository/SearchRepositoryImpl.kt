...
class SearchRepositoryImpl @Inject constructor() : SearchRepository {
    ...
    private fun getMockData(): List<SearchItem> = listOf(
        ...
        SearchItem.HotelItem(Hotel(
            ...
            4.8,
            200,
            listOf("https://picsum.photos/id/164/400/300"),
        )),
        SearchItem.HotelItem(Hotel(
            "2",
            "Icon Hotel",
            ...
            4.5,
            120,
            listOf("https://picsum.photos/id/165/400/300"),
        )),
        SearchItem.HotelItem(Hotel(
            "3",
            "The Ritz-Carlton",
            ...
            4.9,
            350,
            listOf("https://picsum.photos/id/166/400/300"),
        )),
        ...
        SearchItem.HotelItem(Hotel(
            ...
            4.8,
            280,
            listOf("https://picsum.photos/id/167/400/300"),
        )),
